...
import typer
from src.commands import migrate, config

app = typer.Typer(help="Migration Tool")

# Kết nối các nhóm lệnh con vào app chính
app.add_typer(migrate.app, name="migrate")
app.add_typer(config.app, name="config", help="Quản lý cấu hình API Key và hệ thống")
